...
process.once('SIGINT', function cleanup() {
...
PtyRwStream.prototype._destroy = function(exception, cb) {
	if(exception && exception.code === 'EIO')
		exception = null;
	PtyRwStream.super_.prototype._destroy.call(this, exception, cb);
};
...
module.exports.spawn = function(command, args, options) {
	...
	for(i = 0; i < ptyFds.length; i++) {
		...
		case 2: child.stderr = new EventEmitter(); break;
		}
	}
